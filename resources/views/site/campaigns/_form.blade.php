<div class="row row-cols-1 row-cols-md-2">
    ...
    <div class="col">
        <input type="hidden" name="template_type" required value="{{ $owner_id }}" />
    </div>
</div>
<div class="row row-cols-1 row-cols-md-2">
    <div class="col">
...
@if ($template_type === 'STD')
    <div class="row row-cols-1 row-cols-md-2">
        ...
        <div class="col">
            <x-input type="area" label="รายละเอียดยืนยันรับสิทธิ์" name="desc_alert" :value="$desc_alert" required />
        </div>
        <div class="col">
        ...
        <div class="col">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" id="view_btn" name="view_btn" value="{{ $view_btn }}">
                </>
            </div>
        </div>
        <div class="col">
